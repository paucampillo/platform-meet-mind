...
export default function MeetingDetail() {
  ...
  const [outputLanguage, setOutputLanguage] = useState("Español");
  ...
  const sections = [
    ...
    { id: "transcript", label: "Transcripción completa", icon: FileText },
  ];
  ...
  const formats = [
    ...
    },
    {
      ...
      description: "Estructura jerárquica de la reunión",
    },
    {
      id: "mapa" as const,
      icon: Network,
  ...
  const summaryData = {
    context:
      "Reunión de planificación estratégica del primer trimestre de 2026. El equipo de producto y desarrollo se reunió para definir objetivos clave, evaluar la arquitectura actual y establecer prioridades para los próximos meses.",
    keyPoints: [
      {
        icon: Target,
        text: "Objetivo principal: Escalar la plataforma para soportar 100k usuarios simultáneos",
      },
      {
        icon: CheckCircle2,
      ...
      {
        icon: Lightbulb,
        text: "Propuesta de migración a microservicios aceptada por el equipo técnico",
      },
      {
        icon: Target,
        text: "Lanzamiento de versión beta pública programado para abril 2026",
      },
    ],
    openIssues: [
      "Definir estrategia de migración de datos existentes a la nueva arquitectura",
  ...
  const decisions = [
    {
      ...
      context: "Decisión tomada después de analizar el crecimiento proyectado",
    },
    {
      id: "d2",
      text: "Implementar autenticación multi-factor para todos los usuarios",
      context: "Prioridad alta basada en recomendaciones de seguridad",
    },
    {
      id: "d3",
      text: "Lanzar versión beta pública la primera semana de abril",
  ...
  const actionItems = [
    ...
    {
      id: "a3",
      title: "Crear documentación de API endpoints",
  ...
  const suggestions = [
    ...
    "Programar una reunión de seguimiento en 2 semanas para revisar el progreso",
    "Asignar recursos adicionales al equipo de seguridad para la implementación de MFA",
  ];

  const DEFAULT_TRANSCRIPT = `Ana Martínez [00:12:34]: Para el próximo trimestre, necesitamos migrar a una arquitectura de microservicios antes de junio. Es crítico para la escalabilidad del proyecto.

Carlos López [00:13:15]: Estoy de acuerdo. Puedo encargarme de la documentación técnica y preparar el plan de migración para la próxima semana.

María Torres [00:14:02]: Necesitamos también considerar el impacto en el equipo de desarrollo. Propongo organizar sesiones de capacitación en la nueva arquitectura.

Ana Martínez [00:15:20]: Excelente punto María. Carlos, ¿puedes coordinar con RRHH para programar las sesiones de capacitación para abril?

Carlos López [00:16:05]: Sin problema, me encargo de eso. También voy a preparar material de onboarding para los nuevos desarrolladores.
...
Ana Martínez [00:18:45]: Aprobado. David, prepara el informe de costos para el próximo board. María, ¿cuándo tenemos lista la propuesta de arquitectura?

María Torres [00:19:20]: Para el viernes tengo el documento técnico listo. También incluiré un análisis de riesgos.

Carlos López [00:20:10]: Perfecto. Yo me comprometo a tener el plan de migración en fases listo para el lunes. Incluirá los hitos y dependencias.

Ana Martínez [00:21:00]: Excelente. Reunión de seguimiento el 10 de marzo. Todos traigan actualizaciones de sus entregables.`;
  ...
  const pushTasksToManager = (tasksToPush: any[]) => {
    ...
    const mapped: TaskRecord[] = tasksToPush.map((task, index) => {
      ...
      return {
        ...
        title: task.title || `Acción ${index + 1}`,
    ...
    setActionMessage(`${mapped.length} tarea(s) añadidas al gestor.`);
  };
  ...
  const handleExportGenerated = () => {
    ...
    setActionMessage("Exportación lista.");
  };

  const handleExportTranscript = () => {
    if (!transcriptText.trim()) {
      setActionMessage("No hay transcripción para exportar.");
      return;
    }
    ...
    anchor.click();
    URL.revokeObjectURL(url);
    setActionMessage("Transcripción exportada.");
  };
  ...
  const renderGeneratedContent = () => {
    ...
    switch (selectedFormat) {
      ...
      case "mapa": {
        const centralConcept = generatedContent?.centralConcept || "Reunión";
            ...
            <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-indigo-50">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Generar desde transcripción</h2>
              ...
              <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3 mt-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="Visión general">Visión general</SelectItem>
                        ...
                        <div className="flex items-center gap-2">
                          <Label className="text-xs text-gray-500">Formato de exportación</Label>
                          <Select
                            value={exportFormat}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <Label className="text-xs text-gray-500">Incluir estadísticas</Label>
                        </div>
                        <div className="flex items-center gap-2">
                          <Checkbox
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <Label className="text-xs text-gray-500">Enlazar a transcripción</Label>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                {selectedFormat && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-2">Transcripción de la reunión</h3>
                    <textarea
                ...
                {selectedFormat && (
                  <div>
                    ...
                    <p className="text-xs text-gray-500 text-center mt-2">
                      Powered by Claude AI · Basado en la transcripción
                    </p>
                  </div>
                )}
              </CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Generado desde la transcripción
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            {!hasGenerated && !selectedFormat && (
              <Card className="border-gray-200">
                <CardContent className="py-16 text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    La IA generará automáticamente el contenido desde la transcripción
                  </p>
                </CardContent>
              </Card>
            )}
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-gray-900">Extracción automática con IA</h3>
                  </div>
                  <Button
                ...
                {!transcriptText.trim() && (
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-xs text-gray-500">Pega una transcripción en la pestaña "Resumen" para activar la extracción.</p>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between gap-3">
                    <CardTitle className="flex items-center gap-2 text-xl">
                      ...
                      Action Items — Extraídos por IA ({extractedTasks.length})
                    </CardTitle>
              ...
              <Card className="border-gray-200">
                <CardHeader className="pb-4">
                  <CardTitle className="flex items-center gap-2 text-xl">
                    ...
                    Decisiones — Extraídas por IA ({extractedDecisions.length})
                  </CardTitle>
                </CardHeader>
                  ...
                  {extractedDecisions.map((d: any) => (
                    <Card key={d.id} className="border-l-4 border-l-purple-600 bg-purple-50/50">
                      <CardContent className="p-4">
                        ...
                        {d.madeBy && <p className="text-xs text-gray-500">Por: {d.madeBy} · Impacto: {d.impact}</p>}
                      </CardContent>
                    </Card>
                  ))}
                </CardContent>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">
                  Transcripción inteligente en vivo
                </h2>
      ...
      <main className="mx-auto max-w-[1600px] px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <span>·</span>
            <Badge className="bg-blue-100 text-blue-800 border-0">Ejecutándose</Badge>
          </div>
        </div>
              ...
              <div className="sticky top-8 space-y-6">
                ...
                <Card className="border-gray-200">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm font-medium">Progreso de ejecución</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div>
